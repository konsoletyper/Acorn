...
//
//		assertEquals(0, flowLayout.getNearestElementIndex(0f, 0f, elements))
//		assertEquals(0, flowLayout.getNearestElementIndex(-1f, 0f, elements))
//		assertEquals(0, flowLayout.getNearestElementIndex(100f, -1f, elements))
//		assertEquals(1, flowLayout.getNearestElementIndex(40f, 0f, elements))
//		assertEquals(2, flowLayout.getNearestElementIndex(179f, 0f, elements))
//
//		assertEquals(4, flowLayout.getNearestElementIndex(-1f, 70f, elements))
//
//
//		assertEquals(8, flowLayout.getNearestElementIndex(-1f, 160f, elements))
//		assertEquals(elements.lastIndex, flowLayout.getNearestElementIndex(79f, 209f, elements))
//		assertEquals(elements.size, flowLayout.getNearestElementIndex(0f, 210f, elements))
//		assertEquals(elements.size, flowLayout.getNearestElementIndex(80f, 209f, elements))
//	}
//
//	@Test
